...
def render_pre_orcamento_agendamento(
    ...
    pv_redondo = int(round(preco_venda * 0.90))
                ...
                <form id="form_mesa_negociacao" onsubmit="salvarMesaAjax(event)" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <input type="number" name="num_parcelas" id="mesa_num_parcelas" value="{c_parc}" min="1" max="36" oninput="aoMudarEntradaOuParcela()" class="w-full p-2.5 bg-slate-950 border border-slate-700 rounded-xl text-white">
                    </div>
